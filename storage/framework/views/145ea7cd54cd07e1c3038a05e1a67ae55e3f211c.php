<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('trouseres.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <a  href="<?php echo e(route('trouseres.index')); ?>"   type="button" class="btn btn-light " style="width: 100px;opacity: 0.5;">Back</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\blog\resources\views/prodact/pant/create.blade.php ENDPATH**/ ?>